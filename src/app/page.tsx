    ...
    <div className="p-2">
      ...
      <div className="mb-4 w-full flex flex-col">
        <input
          ...
          className="border p-2 mb-1 w-[100%] "
        />
        <input
          type="text"
        ...
        <input
          ...
          className="border p-2 mb-1 w-[45%]"
        />
        <button onClick={handleAddTask} className="bg-blue-500 border text-white p-2 mb-1 w-[45%] rounded-3">
          Add Task
        </button>
      </div>
      <Board />
